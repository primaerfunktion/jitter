...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/data/city2.dam", __ASSET__assets_data_city2_dam);
		type.set ("assets/data/city2.dam", Reflect.field (AssetType, "binary".toUpperCase ()));
		className.set ("assets/data/city2.dam.bak", __ASSET__assets_data_city2_dam_bak);
		type.set ("assets/data/city2.dam.bak", Reflect.field (AssetType, "binary".toUpperCase ()));
		className.set ("assets/data/data-goes-here.txt", __ASSET__assets_data_data_goes_here_txt);
		type.set ("assets/data/data-goes-here.txt", Reflect.field (AssetType, "text".toUpperCase ()));
		className.set ("assets/data/mapCSV_City_background.csv", __ASSET__assets_data_mapcsv_city_background_csv);
		type.set ("assets/data/mapCSV_City_background.csv", Reflect.field (AssetType, "binary".toUpperCase ()));
		className.set ("assets/data/wendy.ttf", __ASSET__assets_data_wendy_ttf);
		type.set ("assets/data/wendy.ttf", Reflect.field (AssetType, "font".toUpperCase ()));
		className.set ("assets/images/car_blue.png", __ASSET__assets_images_car_blue_png);
		type.set ("assets/images/car_blue.png", Reflect.field (AssetType, "image".toUpperCase ()));
		className.set ("assets/images/car_green.png", __ASSET__assets_images_car_green_png);
		type.set ("assets/images/car_green.png", Reflect.field (AssetType, "image".toUpperCase ()));
		className.set ("assets/images/car_red.png", __ASSET__assets_images_car_red_png);
		type.set ("assets/images/car_red.png", Reflect.field (AssetType, "image".toUpperCase ()));
		className.set ("assets/images/car_yellow.png", __ASSET__assets_images_car_yellow_png);
		type.set ("assets/images/car_yellow.png", Reflect.field (AssetType, "image".toUpperCase ()));
		...
		path.set ("assets/data/city2.dam", "assets/data/city2.dam");
		type.set ("assets/data/city2.dam", Reflect.field (AssetType, "binary".toUpperCase ()));
		path.set ("assets/data/city2.dam.bak", "assets/data/city2.dam.bak");
		type.set ("assets/data/city2.dam.bak", Reflect.field (AssetType, "binary".toUpperCase ()));
		path.set ("assets/data/data-goes-here.txt", "assets/data/data-goes-here.txt");
		type.set ("assets/data/data-goes-here.txt", Reflect.field (AssetType, "text".toUpperCase ()));
		path.set ("assets/data/mapCSV_City_background.csv", "assets/data/mapCSV_City_background.csv");
		type.set ("assets/data/mapCSV_City_background.csv", Reflect.field (AssetType, "binary".toUpperCase ()));
		className.set ("assets/data/wendy.ttf", __ASSET__assets_data_wendy_ttf);
		type.set ("assets/data/wendy.ttf", Reflect.field (AssetType, "font".toUpperCase ()));
		path.set ("assets/images/car_blue.png", "assets/images/car_blue.png");
		type.set ("assets/images/car_blue.png", Reflect.field (AssetType, "image".toUpperCase ()));
		path.set ("assets/images/car_green.png", "assets/images/car_green.png");
		type.set ("assets/images/car_green.png", Reflect.field (AssetType, "image".toUpperCase ()));
		path.set ("assets/images/car_red.png", "assets/images/car_red.png");
		type.set ("assets/images/car_red.png", Reflect.field (AssetType, "image".toUpperCase ()));
		path.set ("assets/images/car_yellow.png", "assets/images/car_yellow.png");
		type.set ("assets/images/car_yellow.png", Reflect.field (AssetType, "image".toUpperCase ()));
...
class __ASSET__assets_data_city2_dam extends flash.utils.ByteArray { }
class __ASSET__assets_data_city2_dam_bak extends flash.utils.ByteArray { }
class __ASSET__assets_data_data_goes_here_txt extends flash.utils.ByteArray { }
class __ASSET__assets_data_mapcsv_city_background_csv extends flash.utils.ByteArray { }
class __ASSET__assets_data_wendy_ttf extends flash.text.Font { }
class __ASSET__assets_images_car_blue_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class __ASSET__assets_images_car_green_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class __ASSET__assets_images_car_red_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class __ASSET__assets_images_car_yellow_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class __ASSET__assets_images_images_go_here_txt extends flash.utils.ByteArray { }
class __ASSET__assets_images_tileset1_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
